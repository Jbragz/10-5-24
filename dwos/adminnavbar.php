...
$profile_image = htmlspecialchars($user_info['image'] ?? 'image/depult.jpg'); // Default image if not found
        ...
        <div class="nav__menu">
            ...
            <div class="profile">
                <div class="profile-dropdown">
                    <img src="<?php echo $profile_image; ?>" alt="Profile" onclick="toggleDropdown()" class="profile-image" style="width: 50px; height: 50px;" />
